...
export const RoomLink = () => {
    ...
    const navigateToRoom = () => {
        ...
        setError('Link Invalido, verifique se digitou corretamente');
    }
        ...
        <>
            <div className="container-principal">
                <div className="container-meet link">
                    ...
                    <PublicInput icon={chainIcon} type='text' alt="link" name="Informe o link da reunião para entrar." modelValue={link} setValue={setLink}/>
